...
the maintainers through the disclosure path in `SECURITY.md` once it is published. All
complaints will be reviewed and investigated promptly and fairly.

## Attribution

This Code of Conduct is adapted in spirit from the Contributor Covenant, in short form,
